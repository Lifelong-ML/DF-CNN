...
from classification.train import train_lifelong, train_den_net
...
def train_run_for_each_model(model_architecture, model_hyperpara, train_hyperpara, dataset, data_type, mat_file_name, classification_prob, saved_result=None, useGPU=False, GPU_device=0, doLifelong=False, saveParam=False, saveParamDir=None, saveGraph=False, tfInitParamPath=None):
    ...
    for run_cnt in range(run_cnt_init, max_run_cnt):
        ...
        if ('den' in model_architecture) or ('dynamically' in model_architecture):
        ...
        elif (model_architecture == 'hybrid_dfcnn_auto_sharing_em') or (model_architecture == 'hybrid_hps_cnn_em') or (model_architecture == 'hybrid_tf_cnn_em'):
        ...
        elif (model_architecture == 'hybrid_dfcnn_auto_sharing_em_fixed'):
        ...
        elif (model_architecture == 'hybrid_hps_cnn_darts' or model_architecture == 'hybrid_dfcnn_darts'):
            ...
            raise NotImplementedError("Intentionally removed training function for multi-task learning!")
